      ...
      <div class="mui-card-content">
        <div class="mui-card-content-inner">
          ...
          <p>
            ...
            <mt-button type="danger" size="small" @click="addToShopCar(goodsinfo.sell_price)">加入购物车</mt-button>
...
// 获取numbox商品数量
// 1. 当numbox输入框数值发生改变时，触发change事件，将改变后的数据，通过$emit()触发组件上的自定义事件传递到父组件。
// 2. 点击添加到购物车，将商品数量，同步到Vuex中。
